...
export const THEME_PRESETS: ThemePreset[] = [
  ...
  },
  {
    ...
    emoji: '🎨',
    tagline: 'Precision 3D volumetric glassmorphism canvas with deep blue porcelain cards & cyan glowing accents',
    gradientBg: 'from-indigo-600/40 via-blue-600/30 to-cyan-500/40',
    bannerBg: 'from-indigo-600 via-blue-600 to-cyan-500 border border-indigo-400/30 shadow-xl shadow-indigo-600/20',
    buttonBg: 'bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-500 hover:from-indigo-500 hover:to-cyan-400 text-white font-extrabold shadow-lg shadow-indigo-600/30 active:scale-95 transition-all',
    accentText: 'text-indigo-600 dark:text-cyan-400 font-extrabold',
    badgeBg: 'bg-indigo-100 dark:bg-[#182152] text-indigo-900 dark:text-cyan-300 border border-indigo-200 dark:border-cyan-500/40 font-bold shadow-xs',
    borderColor: 'border-indigo-200 dark:border-[#1e2756]',
    previewColors: ['#4f46e5', '#2563eb', '#06b6d4'],
    pageBg: 'bg-gradient-to-br from-[#f0f4ff] via-[#e5ecff] to-[#dbe4ff] dark:from-[#090d20] dark:via-[#0e1330] dark:to-[#070a1a]',
    cardBg: 'bg-white/90 dark:bg-[#101633]/90 backdrop-blur-2xl shadow-[0_15px_35px_rgba(79,70,229,0.08)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.7)]',
    cardBorder: 'border border-indigo-200/80 dark:border-[#232d63] hover:border-cyan-400 dark:hover:border-cyan-400 shadow-xl transition-all',
    innerCardBg: 'bg-indigo-50/70 dark:bg-[#171e48]/90 backdrop-blur-xl border border-indigo-100 dark:border-[#2a3575]',
    headerBg: 'bg-white/90 dark:bg-[#0c1029]/90 backdrop-blur-2xl border-b border-indigo-100 dark:border-[#1e2756]',
    heroCardBg: 'bg-gradient-to-br from-white via-indigo-50/80 to-blue-50/50 dark:from-[#18204e]/95 dark:via-[#11173d]/95 dark:to-[#0b0e27]/95 border border-indigo-200 dark:border-[#2f3b7d] shadow-2xl',
    inputBg: 'bg-white dark:bg-[#0d122b] border border-indigo-200 dark:border-[#253069] text-slate-900 dark:text-indigo-50 placeholder-indigo-400/60 font-semibold',
    secondaryButtonBg: 'bg-indigo-100/80 hover:bg-indigo-200/80 dark:bg-[#1c2557] dark:hover:bg-[#253173] text-indigo-900 dark:text-indigo-100 border border-indigo-200 dark:border-[#2f3c80] font-bold',
    modalBg: 'bg-white/95 dark:bg-[#0c1029]/95 border border-indigo-200 dark:border-[#232d63] backdrop-blur-3xl',
